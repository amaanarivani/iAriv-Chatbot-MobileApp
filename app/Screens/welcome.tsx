  ...
  return (
    <SafeAreaView style={{ backgroundColor: "black", height: "100%" }}>
      ...
      <View style={{ paddingHorizontal: 20 }}>
        <Text style={{ color: "white", fontSize: 30, fontWeight: "bold", textAlign: "center" }}>Welcome to iAriv Chatbot, Great Friend to Chat</Text>
        <Pressable style={{ backgroundColor: "#0286F2", padding: 20, marginTop: 25, borderRadius: 15 }} onPress={() => router.push("/Screens/signin")}>
