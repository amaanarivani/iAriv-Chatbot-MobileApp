    ...
    return (
        <>
            <SafeAreaView style={{ height: "100%", backgroundColor: "#6969D7" }}>
                ...
                <ScrollView style={{ backgroundColor: "white", borderTopLeftRadius: 20, borderTopRightRadius: 20 }} automaticallyAdjustKeyboardInsets keyboardShouldPersistTaps={'handled'}>
                    ...
                    <View style={{ backgroundColor: "white", marginTop: 30, width: "90%", marginHorizontal: "auto", borderRadius: 15, marginBottom: 80 }}>
